        ...
        <div class="col-lg-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('userProfile.update', ['id' => $user->id]) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="entity_name" type="text" class="form-control @error('entity_name') is-invalid @enderror" name="entity_name" value="{{ $user->entity_name }}" required autofocus>
