            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="form-group row">
                            <label for="entity_name" class="col-md-4 col-form-label text-md-right">{{ __('会社・団体名') }}</label>

                            <div class="col-md-6">
                                <input id="entity_name" type="text" class="form-control @error('entity_name') is-invalid @enderror" name="entity_name" value="{{ old('entity_name') }}" required autocomplete="entity_name" autofocus>
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="keyphrase" type="password" class="form-control" name="keyphrase" required>
