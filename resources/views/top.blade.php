    ...
    <div class="pg-top">
        ...
        <section class="what-is-gt">
            <div class="container-fluid">
                <div class="row py-5">
                    <div class="col-md-8 col-xl-7 offset-md-1 offset-xl-2 descr">
                        ...
                        <p class="py-3 pr-md-3 pr-xl-5 text-right"><span class="h1 text-primary pr-3">知日</span>日本を知り、日本語を扱える</p>
                    </div>
                    <div class="impr"></div>
                </div>
            </div>
